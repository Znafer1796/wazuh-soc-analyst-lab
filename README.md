...
![Architecture](architecture/soc-lab-diagram.png)
...
![Wazuh Nmap Alert](wazuh/wazuh-alert-nmap.png)
...
![Wazuh Metasploit Alert](wazuh/wazuh-metasploit.png)
...
* More attack scenarios and screenshots will be added over time
